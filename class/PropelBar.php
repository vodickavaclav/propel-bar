...
/**
 * Copyright (c) 2012, Tomáš Kraut <tomas.kraut@matfyz.cz>
 *
...
/**
 * PropelBar - shows SQL queries generated by Propel in Nette debugger bar
 *
 * @author Tomáš Kraut <tomas.kraut@matfyz.cz>
 */
class PropelBar extends \Nette\Object implements Diagnostics\IBarPanel, \BasicLogger
{
	...
	{
		return Diagnostics\Helpers::editorLink($row['source'][0], $row['source'][1])->class('nette-PropelBar-source');
	}
...
<div class="nette-inner nette-PropelBar">
<table>
<tr>
...
HTML;
	...
	public static function register(\PropelPDO $connection, $libraryPaths = array())
	{
		...
		//Diagnostics\Debugger::$blueScreen->addPanel(array($panel, 'renderException'));
		return $panel;
	}
