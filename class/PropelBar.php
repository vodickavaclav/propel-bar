...
/**
 * Copyright (c) 2012-2015, Tomáš Kraut <tomas.kraut@matfyz.cz>, updated for NSM by Václav Vodička <vaclav.vodicka92@gmail.com>
 *
...
HTML;
	...
	public function getRows()
	{
		...
		return implode('', array_map(function ($message) use ($self) {
			return '<tr>'
				...
				. '<td class="sql">' . Database\Helpers::dumpSql($self->extractSql($message)) . $self->extractLink($message) . '</td>'
	 ...
	 * @return PropelBar
	 */
	public static function register($connection, $libraryPaths = array())
	{
		$panel = new static();
		$bar = Debugger::getBar();
		if ($bar != null) {
	...
	protected function setConnection(\PropelPDO $connection)
	{
		...
		$propelConfig = $connection->getConfiguration();
